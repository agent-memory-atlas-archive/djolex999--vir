...
| `vir lint --legacy-related` | free  | Pre-0.12.0 notes whose stored Related holds content a rewrite drops |
| `vir lint --legacy-related --fix` | free | Move that content into `## Details`, re-render the notes |
